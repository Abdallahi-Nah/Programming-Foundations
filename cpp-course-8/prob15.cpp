...
int differenceBetweenTwoDays(sDate date1, sDate date2, bool isEndDayIncluded = false) {
    ...
    return (totalDaysForDate1 < totalDaysForDate2 ? ((isEndDayIncluded) ? (totalDaysForDate2 - totalDaysForDate1 + 1) : (totalDaysForDate2 - totalDaysForDate1)) : ((isEndDayIncluded) ? (totalDaysForDate2 - totalDaysForDate1 - 1) : (totalDaysForDate2 - totalDaysForDate1)));  
}
